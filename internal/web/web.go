...
//go:embed assets/output.css assets/htmx.min.js assets/sortable.min.js assets/board-drag.js assets/card-control.js assets/favicon.svg assets/avatars/*.svg
